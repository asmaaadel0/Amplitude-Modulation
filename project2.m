...
demodulate_signal(mod_s, carr1_10, Length_First_Signal, Fs_First_Signal, Fs_new, 24000, f_res, 'res1_10')

%demodulation second signal phase 10
demodulate_signal(mod_s, carr2_10, Length_Second_Signal, Fs_Second_Signal, Fs_new, 24000, f_res, 'res2_10')

%demodulation third signal phase 10
demodulate_signal(mod_s, carr3_10, Length_Third_Signal, Fs_Third_Signal, Fs_new, 24000, f_res, 'res3_10')
...
demodulate_signal(mod_s, carr1_30, Length_First_Signal, Fs_First_Signal, Fs_new, 24000, f_res, 'res1_30')

%demodulation second signal phase 30
demodulate_signal(mod_s, carr2_30, Length_Second_Signal, Fs_Second_Signal, Fs_new, 24000, f_res, 'res2_30')

%demodulation third signal phase 30
demodulate_signal(mod_s, carr3_30, Length_Third_Signal, Fs_Third_Signal, Fs_new, 24000, f_res, 'res3_30')
...
demodulate_signal(mod_s, carr1_90, Length_First_Signal, Fs_First_Signal, Fs_new, 24000, f_res, 'res1_90')

%demodulation second signal phase 90
demodulate_signal(mod_s, carr2_90, Length_Second_Signal, Fs_Second_Signal, Fs_new, 24000, f_res, 'res2_90')
